 ...
 *
 * @param Kafka\Amp\Reactor $assign Optionally specify a new default event reactor instance
 * @return Kafka\Amp\Reactor Returns the application-wide reactor instance
 */
 ...
 * promise is failed.
 *
 * @param Kafka\Amp\Promise $promise The promise to which the timeout applies
 ...
 *
 * @param Kafka\Amp\Promise $promise The promise on which to wait
