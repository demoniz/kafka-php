...
class Socket
{
    ...
    public function connect()
    {
        ...
        $this->readWatcher = \Kafka\Amp\onReadable($this->stream, function () {
            do {
        ...
        $this->writeWatcher = \Kafka\Amp\onWritable($this->stream, function () {
            $this->write();
    ...
    public function close()
    {
        \Kafka\Amp\cancel($this->readWatcher);
        \Kafka\Amp\cancel($this->writeWatcher);
    ...
    public function write($data = null)
    {
        ...
        if ($bytesToWrite === $bytesWritten) {
            \Kafka\Amp\disable($this->writeWatcher);
        } elseif ($bytesWritten >= 0) {
            \Kafka\Amp\enable($this->writeWatcher);
